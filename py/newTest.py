...
if __name__ == '__main__':
    ...
    #Σ10 = np.array([seFunc(ε, taucoef=10) for ε in Erg])
    #Σ01 = np.array([seFunc(ε, taucoef=0.1) for ε in Erg])
    ...
    #plt.plot(Erg, Σ10, linewidth=1, label=r"τ=$10\ \tau_0$")
    #plt.plot(Erg, Σ01, linewidth=1, label=r"τ=$0.1\ \tau_0$")
